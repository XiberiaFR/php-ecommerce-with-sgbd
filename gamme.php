...
$queryproductlist1 = "SELECT * FROM articles WHERE id_gamme = 1 ORDER BY RAND()";
$queryproductlist2 = "SELECT * FROM articles WHERE id_gamme = 2 ORDER BY RAND()";
$queryproductlist3 = "SELECT * FROM articles WHERE id_gamme = 3 ORDER BY RAND()";
...
$tableauarticles1 = array();

while ($resultatsarticles = $result1->fetch(PDO::FETCH_ASSOC)) {
    $tableauarticles1[] = $resultatsarticles;
}

$tableauarticles2 = array();

while ($resultatsarticles = $result2->fetch(PDO::FETCH_ASSOC)) {
    $tableauarticles2[] = $resultatsarticles;
}

$tableauarticles3 = array();

while ($resultatsarticles = $result3->fetch(PDO::FETCH_ASSOC)) {
    $tableauarticles3[] = $resultatsarticles;
}
...
<body>
    ...
    <header class="container-fluid header">
        ...
        <section class="headersection vh-100 d-flex justify-content-evenly align-items-center flex-column">
            <h1 class="headersection__title">Nos gammes d'ours en peluche</h1>
            <a href="#main" class="btn btn-warning">Je découvre les gammes</a>
        </section>

    </header>

    <main class="container-fluid homepage mt-5 pt-5" id="main">
    <div class="row">
            <h2 class="text-center bg-warning pb-2">Gamme Alpes</h2>
            <div class="row mt-2 mb-5 col-md-12 d-flex justify-content-around align-items-center">
                <?php
                while (count($tableauarticles1) > 0) {
                    $product = array_shift($tableauarticles1); ?>
        ...
        <div class="row">
            <h2 class="text-center bg-warning pb-2">Gamme Pyrénées</h2>
            <div class="row mt-2 mb-5 col-md-12 d-flex justify-content-around align-items-center">
                <?php
                while (count($tableauarticles2) > 0) {
                    $product = array_shift($tableauarticles2); ?>
                    <section class="product col-md-3 text-center shadow p-3 mb-5 bg-white rounded">
        ...
        <div class="row">
            <h2 class="text-center bg-warning pb-2">Gamme Vosges</h2>
            <div class="mt-2 mb-5 row col-md-12 d-flex justify-content-around align-items-center">
                <?php
                while (count($tableauarticles3) > 0) {
                    $product = array_shift($tableauarticles3); ?>
                    <section class="product col-md-3 text-center shadow p-3 mb-5 bg-white rounded">
